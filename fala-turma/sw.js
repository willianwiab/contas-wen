...
const CACHE = 'fala-turma-v8';
const ARQUIVOS = ['./', './index.html', './turma.js?v=8', './turma-mais.js?v=8', './turma-cara.js?v=8', './turma-socorro.js?v=8', './turma-escola.js?v=8', './turma-junto.js?v=8',
