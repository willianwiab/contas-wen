/* Guarda o site pra abrir sem internet. Um cofrinho é coisa de olhar
   toda semana, e travar numa tela branca porque o wi-fi caiu seria
   o jeito mais rápido de a pessoa desistir de usar.
   Pedido pra fora do site passa direto, e um arquivo que falhou
   nunca vira a página. */
const CACHE = 'cofrinho-v1';
const ARQUIVOS = ['./', './index.html', './cofrinho.js?v=1', './manifest.webmanifest', './icone.svg'];
