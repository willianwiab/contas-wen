/* Guarda o site pra abrir sem internet — importante num jogo em que
   a pessoa está na rua, onde o sinal costuma ser ruim. Pedido pra fora
   do site passa direto, e um arquivo que falhou nunca vira a página. */
const CACHE = 'caca-tesouro-v1';
const ARQUIVOS = ['./', './index.html', './caca.js?v=1', './manifest.webmanifest', './icone.svg'];
